...
<div id="log_wrapper">
    <div id="log_show">
        <a href="input_log.php">Input Log</a>&nbsp;&nbsp;<a href="consume_log.php">Consume Log</a>&nbsp;&nbsp;<a id="distribute_id_link" href="distribute_id.php">Distribute ID table</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div>Welcome user: <?php
        echo $_SESSION["realname"]?></div> 
        <h1>Summary</h1>
        <table id ="log_table">
