...
?>
    <table id ="id_table"> <!-- style="visibility: hidden"> -->
        <tr><td><font size =5>Real Name</font></td><td><font size =5>User Name</font></td><td><font size =5>Password</font></td><td><font size =5>Edit</font></td></tr>
<!--        <tr><td>administrator</td><td>password</td><td><select onchange ="select_edit_delete(this)"><option>edit</option><option></option><option>update</option></select></td></tr>-->
        <tr><td>You can add new user below!</td><td></td><td></td><td></td></tr>
        <tr><td><input type ="text" name ="add_realName"></td><td><input type ="text" name ="add_user"></td><td><input type ="text" name ="add_password"></td><td></td></tr>
        <tr><td><input type ="text" name ="add_realName"></td><td><input type ="text" name ="add_user"></td><td><input type ="text" name ="add_password"></td><td></td></tr>
        <tr><td><input type ="text" name ="add_realName"></td><td><input type ="text" name ="add_user"></td><td><input type ="text" name ="add_password"></td><td></td></tr>
        <tr><td><input type ="text" name ="add_realName"></td><td><input type ="text" name ="add_user"></td><td><input type ="text" name ="add_password"></td><td></td></tr>
        <tr><td></td><td></td><td><button id ="button_user">add one user</button></td><td></td></tr>
<!--
