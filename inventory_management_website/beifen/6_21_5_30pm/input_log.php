...
<div id="log_wrapper">
    <div id="log_show">
        <table id ="log_table">
            ...
            <tr><td><h3>Add new logs below:</h3></td><td><h3>Product</h3></td><td><h3>Brand</h3></td><td><h3>Quantity</h3></td><td><h3>Price</h3></td><td></td><td><button id="confirm_update">confirm</button></td><td><button id="confirm_delete">confirm</button></td></tr>
...
function delete_user(s){
    ...
    var key = s.parentNode.parentNode.childNodes[8].childNodes[0].childNodes[0].nodeValue;
    alert(s.parentNode.parentNode.childNodes[8].childNodes[0].childNodes[0].tagName);
    //alert("key is :"+key);
...
function ajax_trigger(sign, product, brand, quantity, price,key){
    //$("#debug").text(password);
    //alert(password);
    $.ajax({
        url: "input_table.php",
