...
<!--css link-->
<link rel="stylesheet" type="text/css" href="table_style_summary.css" />
</head>

<body background="background-1.jpg" style="background-size: 100%">
    <header><button id="logout_id">logout</button>
				<nav class="codrops-demos">
					<span>Welcome user: <strong><?php echo $_SESSION["realname"]?></strong></span>
					<a href="input_log.php">Input Log</a>
...
<div id="log_wrapper">
    <div id="log_show">
        <h1>Summary</h1>
        <table id ="log_table">
            <tr><td><h4>Product</h4></td><td><h4>Brand</h4></td><td><h4>Quantity</h4></td><td><h4>Price</h4></td><td width=20%><h4>Last_Modified</h4></td><td><h4>Input</h4></td><td width=12%><h4>Consume</h4></td><td id="delete_icon"><h4>delete</h4></td><td><h4>Key</h4></td></tr>
            <tr><td colspan="2"><label>Add new products below</label></td><td></td><td></td><td></td><td><button id="input">confirm</button></td><td><button id="consume">confirm</button></td><td><button id="delete">confirm</button></td><td></td></tr>
            <tr><td colspan="2"><h3>Product</h3></td><td colspan="2"><h3>Brand</h3></td><td><h3>Quantity</h3></td><td colspan="2"><h3>Price</h3></td><td></td><td></td></tr>
            <tr><td colspan="2"><input type ="text" name ="product"></td><td colspan="2"><input type ="text" name ="brand"></td><td><input type ="text" name ="quantity"></td><td><input type ="text" name ="price"></td><td></td><td></td><td></td></tr>
            <tr><td colspan="2"><input type ="text" name ="product"></td><td colspan="2"><input type ="text" name ="brand"></td><td><input type ="text" name ="quantity"></td><td><input type ="text" name ="price"></td><td></td><td></td><td></td></tr>
            <tr><td colspan="2"><input type ="text" name ="product"></td><td colspan="2"><input type ="text" name ="brand"></td><td><input type ="text" name ="quantity"></td><td><input type ="text" name ="price"></td><td></td><td></td><td></td></tr>
            <tr><td colspan="2"><input type ="text" name ="product"></td><td colspan="2"><input type ="text" name ="brand"></td><td><input type ="text" name ="quantity"></td><td><input type ="text" name ="price"></td><td></td><td></td><td></td></tr>
            <tr><td></td><td></td><td></td><td></td><td colspan="2"><button id="add">Add The Product</button></td><td></td><td></td><td></td></tr>
        </table>
<div>
...
function validate(){
    ...
    //alert("successfully add products");
}
/*    
function validate(){
...
function pagination_f(obj){
    ...
    $('#debug1').text("Page item clicked, total Pages: "+totalPages+" page: "+page);
...
function show_form(output){
    ...
    if(output ==="update"){
        alert("one product is updated");
        return;
    }
    if(output ==="delete" ){
        alert("one inventory has been deleted!");
        return;
    }
