...
<div id="log_wrapper">
    <div id="log_show">
        <table id ="log_table">
            <tr><td><h3>Employee</h3></td><td><h3>Product</h3></td><td><h3>Brand</h3></td><td><h3>Quantity</h3></td><td><h3>Price</h3></td><td><h3>Date</h3></td><td><h3>Update</h3></td><td><h3>Delete</h3></td><td></td></tr>
...
function update_user(s){
    ...
    //ajax_trigger(sign, employee, product, brand, quantity, price,key)
...
function pagination_f(obj){
    ...
    var options = {
                ...
                onPageClicked: function(e,originalEvent,type,page){
                    ...
                    //var row = document.getElementById("log_table").insertRow(1);
                    var row; var cell1; var cell2; var cell3; var cell4; var cell5; var cell6; var cell7;
                    var i=0;
                    ...
                    for(var i =item_to-1; i>=item_from;i--){
                        //row = document.getElementById("log_table").rows;
                        row = document.getElementById("log_table").insertRow(1);
                        cell1 = row.insertCell(0);
                        cell2 = row.insertCell(1);
                        cell3 = row.insertCell(2);
