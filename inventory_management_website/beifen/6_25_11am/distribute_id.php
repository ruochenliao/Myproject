...
?>
    <table id ="id_table"> <!-- style="visibility: hidden"> -->
        <tr><td><font size =5>Real Name</font></td><td><font size =5>User Name</font></td><td><font size =5>Password</font></td><td><font size =5>Update</font></td><td><font size =5>Delete</font></td><td></td></tr>

        <tr><td><h3>Add new user below!</h3></td><td><h3>User Name</h3></td><td><h3>Password</h3></td><td><button id="update">confirm</button></td><td><button id="confirm_delete">confirm</button></td><td></td></tr>
        ...
        <tr><td><input type ="text" name ="add_realName"></td><td><input type ="text" name ="add_user"></td><td><input type ="text" name ="add_password"></td><td></td><td></td><td></td></tr>
        <tr><td><input type ="text" name ="add_realName"></td><td><input type ="text" name ="add_user"></td><td><input type ="text" name ="add_password"></td><td></td><td></td><td></td></tr>
        <tr><td></td><td></td><td><button id ="button_user">add one user</button></td><td></td><td></td><td></td></tr>
<!--
...
function update_user(r){
    ...
    */
    ...
    //ajax_trigger(real_name,username, password, sign,original_username,original_password)
