...
<!--css link-->
<link rel="stylesheet" type="text/css" href="table_style_consume.css" />
</head>

<body background="background-3.jpg" style="background-size: 100%">
<header>
...
<div id="log_wrapper">
    <div id="log_show">
        ...
        <table id ="log_table">
            ...
            <tr name="hideme"><td><div type ="text" name ="employee"/></td><td><input type ="text" name ="product"></td><td><input type ="text" name ="brand"></td><td><input type ="text" name ="quantity"></td><td><input type ="text" name ="price"></td><td></td><td></td></tr>
            <tr name="hideme"><td><div type ="text" name ="employee"/></td><td><input type ="text" name ="product"></td><td><input type ="text" name ="brand"></td><td><input type ="text" name ="quantity"></td><td><input type ="text" name ="price"></td><td></td><td></td></tr>
                <tr name="hideme"><td></td><td></td><td></td><td></td><td><button id="button_user">add logs</button></td><td></td><td></td></tr>
        </table>
<div>
